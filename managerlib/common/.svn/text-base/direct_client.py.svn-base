...
from managerlib.common.bufferedhttp import http_connect
from swiftclient import ClientException, json_loads
from managerlib.common.utils import normalize_timestamp
from managerlib.common.http import HTTP_NO_CONTENT, HTTP_INSUFFICIENT_STORAGE, \
