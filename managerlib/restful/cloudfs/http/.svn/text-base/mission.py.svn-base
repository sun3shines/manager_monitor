...
from managerlib.restful.cloudfs.lib_token import libGetToken
from managerlib.globalx.static import CLOUDFS_HOST,CLOUDFS_PORT,CLOUDFS_CA_CRT,CLOUDFS_CA_KEY,HTTP_TIMEOUT
