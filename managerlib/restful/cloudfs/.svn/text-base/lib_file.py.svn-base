...
import json
from managerlib.restful.cloudfs.http.mission import TestMission
from managerlib.restful.cloudfs.http.advanced_task import FileUpload,FileDownload,FileList
from managerlib.restful.cloudfs.http.basic_task import UfoObjectGet,UfoObjectDelete
