...
from monitorexecutor.globalx import HTTP_TIMEOUT,MONITOR_SERVER_HOST,MONITOR_SERVER_PORT
...
class Mission:
    ...
    def getHttpsConn(self):
        ...
        return HTTPConnection(MONITOR_SERVER_HOST,MONITOR_SERVER_PORT,True,HTTP_TIMEOUT)  
