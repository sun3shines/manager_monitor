...
from managerlib.db.table.dynamic.stat_net import Network, update_net,insert_net
from managerlib.db.table.dynamic.stat_net import hid2attrs as NEThid2attrs
