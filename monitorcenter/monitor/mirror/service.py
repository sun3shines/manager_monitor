...
from managerlib.db.table.dynamic.stat_service import Service, update_service,insert_service
from managerlib.db.table.dynamic.stat_service import hid2attrs as SERVICEhid2attrs
