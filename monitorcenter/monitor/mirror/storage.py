...
from managerlib.db.table.dynamic.stat_storage import Storage, update_storage,insert_storage
from managerlib.db.table.dynamic.stat_storage import hid2attrs as STORAGEhid2attrs
